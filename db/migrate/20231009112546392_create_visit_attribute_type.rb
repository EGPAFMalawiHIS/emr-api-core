...
# Migration responsible for creating the visit_attribute_type table
class CreateVisitAttributeType < ActiveRecord::Migration[6.0]
  def change
    create_table :visit_attribute_type, id: false do |t|
      t.bigint :visit_attribute_type_id, null: false, limit: 4
