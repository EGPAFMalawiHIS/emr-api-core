...
# Migration responsible for creating the person_attribute_type table
class CreatePersonAttributeType < ActiveRecord::Migration[6.0]
  def change
    create_table :person_attribute_type, id: false do |t|
      t.bigint :person_attribute_type_id, null: false, limit: 4
      t.string :name, null: false, default: '', limit: 50
      t.text :description, limit: 65535
      t.string :format, limit: 50
      t.bigint :foreign_key, limit: 4
      t.boolean :searchable, null: false, default: '0'
