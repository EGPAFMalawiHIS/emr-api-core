...
# Migration responsible for creating the provider_attribute_type table
class CreateProviderAttributeType < ActiveRecord::Migration[6.0]
  def change
    create_table :provider_attribute_type, id: false do |t|
      t.bigint :provider_attribute_type_id, null: false, limit: 4
