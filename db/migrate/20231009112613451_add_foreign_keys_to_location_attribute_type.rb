...
# Migration responsible for adding foreign keys to the location_attribute_type table
class AddForeignKeysToLocationAttributeType < ActiveRecord::Migration[6.0]
  def change
