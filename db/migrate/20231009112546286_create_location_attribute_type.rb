...
# Migration responsible for creating the location_attribute_type table
class CreateLocationAttributeType < ActiveRecord::Migration[6.0]
  def change
    create_table :location_attribute_type, id: false do |t|
      t.bigint :location_attribute_type_id, null: false, limit: 4
