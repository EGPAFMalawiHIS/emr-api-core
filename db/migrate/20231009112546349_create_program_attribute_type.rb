...
# Migration responsible for creating the program_attribute_type table
class CreateProgramAttributeType < ActiveRecord::Migration[6.0]
  def change
    create_table :program_attribute_type, id: false do |t|
      t.bigint :program_attribute_type_id, null: false, limit: 4
