class Api::V1::VisitAttributesController < ApplicationController
  ...
  private
    ...
    def visit_attribute_params
      params.require(:visit_attribute).permit(:visit_id, :attribute_type_id, :value_reference, :uuid, :creator, :date_created, :changed_by, :date_changed, :voided, :voided_by, :date_voided, :void_reason)
    end
end
