class Api::V1::VisitAttributeTypesController < ApplicationController
  before_action :set_visit_attribute_type, only: [:show, :update, :destroy]
  ...
  private
    ...
    def visit_attribute_type_params
      params.require(:visit_attribute_type).permit(:name, :description, :datatype, :datatype_config, :preferred_handler, :handler_config, :min_occurs, :max_occurs, :creator, :date_created, :changed_by, :date_changed, :retired, :retired_by, :date_retired, :retire_reason, :uuid)
    end
end
