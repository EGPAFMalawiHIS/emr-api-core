...
class Concept < ApplicationRecord
  ...
  has_many :concept_answer, foreign_key: concept_id, primary_key: concept_id
  ...
  has_many :concept_proposal, foreign_key: obs_concept_id, primary_key: concept_id
  ...
  has_many :concept_set, foreign_key: concept_id, primary_key: concept_id
  ...
  validates :datatype_id, presence: true
